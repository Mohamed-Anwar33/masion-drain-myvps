...
const CategoriesEditor: React.FC = () => {
  const { data, loading, updateSection } = useHomePageSection('categories');
    ...
    <div className="space-y-8" dir="rtl">
      <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
        <div className="flex items-center">
          ...
          <span className="font-medium text-gray-900">عرض قسم الفئات</span>
        </div>
      ...
      <div className="space-y-2">
        ...
        <input
          ...
          onChange={handleInputChange}
          placeholder="استكشف مجموعتنا المتنوعة من فئات منتجات التجميل والعطور"
          className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary/20 focus:border-primary transition-colors"
        />
      </div>
